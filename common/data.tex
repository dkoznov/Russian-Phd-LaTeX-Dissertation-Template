...
{\texorpdfstring{\MakeUppercase{Применение операционных подходов к описанию слабых моделей памяти}}
                               {Применение операционных подходов к описанию слабых моделей памяти}}
