...
\fr{\LARGE Публикации}{
  ...
  \begin{block}{Scopus, Web of Science}
    \begin{itemize}
      \item Promising compilation to ARMv8 POP, ECOOP 2017 \\
  ...
  \begin{block}{arXiv}
    \begin{itemize}
      \item Operational Aspects of C/C++ Concurrrency, 2016 \\
